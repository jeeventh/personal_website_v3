        ...
        builder: (_, box, __) {
          ...
          return MaterialApp(
            ...
            darkTheme: ThemeData.dark().copyWith(
              ...
              textSelectionColor: const Color(0xff03dac6),
  ...
  static final List<Widget> _content = [
    ...
    Center(
      child: Padding(
        ...
        child: Text(
            '© ${DateTime.now().year} Jeeventh Kubenthiran. All rights reserved.'),
      ),
    )
  ]
      .map(
...
class Info extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ListView(
        ...
        children: [
          ...
          ButtonBar(
            children: [
              [FontAwesome5Brands.github, 'https://github.com/jeeventh'],
              [
                FontAwesome5Brands.twitter,
                'https://twitter.com/jeeev1'
              ]
            ]
                .map(
                  (e) => Tooltip(
        ...
        children: [
          ...
          const ListTile(
            title: Text(
              ...
              'I\'m a Mechanical Engineer with a Masters Degree and also a self-taught full stack developer who is self-motivated and open to learn new things',
            ),
          ),
          const SizedBox(
            height: 32,
          ...
          Wrap(
            ...
            children: [
              ...
              [
                ...
                'https://github.com/jeeventh/BMI_Calculator'
              ],
              [
                'Flash Chat',
                'Simple Messenger App Using Flutter',
                'https://www.jeeven.me/bmicalc/#/'
              ],
              [
                'Brew Crew',
                'Group Coffee preference App Using Flutter',
                'https://www.jeeven.me/bmicalc/#/'
              ],          
              [
                'Volt Fence',
                'Built a complete website for local electric fence company',
                'https://www.voltfence.my'
              ],
              [
                'Personal Website v1',
                'Personal Website Built using HTML, CSS and Bootstrap',
                'https://github.com/jeeventh/personal_website_v1'
              ],
            ]
                .map(
                  (e) => ConstrainedBox(
